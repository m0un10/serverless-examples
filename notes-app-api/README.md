Below is the auto-generated README.md from `serverless install --url https://github.com/AnomalyInnovations/serverless-nodejs-starter --name notes-app-api` (more details [here](https://serverless-stack.com/chapters/setup-the-serverless-framework.html)). To learn more about the application click [here](ABOUT.md)
